...
namespace BeehiveManagementSystem
{
    public partial class frm_Main : Form
    {
        ...
        public frm_Main()
        {
            ...
            workers[0] = new Worker(new string[] { "Сбор нектара", "Производство меда" }, 175);
            workers[1] = new Worker(new string[] { "Забота о яйцах", "Обучение маленьких пчел" }, 114);
...
"Забота о яйцах", "Обучение маленьких пчел", "Обслуживание улья", "Патрулирование" }, 155);
