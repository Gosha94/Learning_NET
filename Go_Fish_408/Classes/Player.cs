...
namespace Go_Fish_408.Classes
{
    class Player
    {
        ...
        public Player(String name, Random random, TextBox textBoxOnForm)
        {
            ...
            textBoxOnForm.Text += name + " присоединился к игре" + Environment.NewLine;
        }
        ...
        public Deck DoYouHaveAny(Values value)
        {
            ...
            textBoxOnForm.Text += Name + " держит " + cardsIHave.Count + " "
 + Card.Plural(value) + Environment.NewLine;
        ...
        public void AskForACard(List<Player> players, int myIndex, Deck stock)
        {
            ...
            {
                textBoxOnForm.Text += Name + " спрашивает, есть ли у кого то "
